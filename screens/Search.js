...
export default class SearchScreen extends Component {
  ...
  renderItem=({item,i})=>{
    ...
    var transactionType = item.transaction_tip === 'issue'? 'retirado':'devolvido'
              ...
              <View style={styles.transactionContainer}>
                <Text
                  style={[
                    ...
                    {
                      color:
                        item.transaction_tip === "issue"
                          ? "#78D304"
                          : "#0364F4"
                    }
                  ]}
                >
                  {item.transaction_tip.charAt(0).toUpperCase() +
                    item.transaction_tip.slice(1)}
                </Text>
                <Icon
                  type={"ionicon"}
                  name={
                  ...
                  color={
                    item.transaction_tip === "issue" ? "#78D304" : "#0364F4"
                  }
                />
              </View>
  ...
  handleSearch= async text => {
    var textTratado  = text.toUpperCase().split('')
      ...
      <View style={styles.container}>
        <View style={styles.upperContainer}>
          <View  style={styles.textinputContainer}>
            <TextInput style={styles.textinput} onChangeText={text=>this.setState({searchText:text})} placeholder="Digite Aqui" placeholderTextColor={"#fff"}/>
